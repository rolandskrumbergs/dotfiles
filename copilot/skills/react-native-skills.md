...
description: 'Comprehensive React Native performance optimization guide with 35+ rules across 13 categories — core rendering, list performance, animation, scroll performance, navigation, React state, state architecture, React Compiler, images, effects, styling, fonts, and imports. Use when writing, reviewing, or refactoring React Native code for performance.'
---
# React Native Skills
